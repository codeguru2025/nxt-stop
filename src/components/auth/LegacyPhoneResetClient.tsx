...
// Admin-mediated fallback for accounts without a usable email on file.
// The primary self-service path is ForgotPasswordClient.tsx (email + reset link).
export default function LegacyPhoneResetClient() {
  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        />
        <h1 className="text-2xl font-black text-white">Request Admin Help</h1>
        <p className="text-gray-500 text-sm mt-1">
          No email on file? Submit a request — an admin will reset it for you
        </p>
      </div>

      <div className="card p-6">
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-3 mb-5 text-sm text-blue-300">
          If you don't have an email on your account, an admin manually verifies requests
