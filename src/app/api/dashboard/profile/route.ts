...
const PROFILE_SELECT = {
  ...
  email: true, homeTown: true, isWhatsApp: true,
} as const

// Phone is the login identity, so it isn't editable here — an admin changes it.
...
export async function PATCH(req: Request) {
  try {
    ...
    const { firstName, lastName, email, homeTown, isWhatsApp } = parsed.data
